...
classifier = tf.estimator.Estimator(model_dir="C:/Users/HP NOTE/Desktop/train", model_fn=cnn_model_fn)
prediction = None
...
def get_image_size():
	img = cv2.imread('C:/Users/HP NOTE/Desktop/train/0/0.jpg', 0)
	return img.shape
...
def get_pred_text_from_db(pred_class):
	conn = sqlite3.connect("C:/Users/HP NOTE/Desktop/train/signlanguage.db")
